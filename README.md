# DRAFT - Angular Boot Camp Curriculum - content-projection
...
[StackBlitz for content-projection](https://stackblitz.io/github/AngularBootCamp/content-projection)

Alternatively, you can clone the repository locally and run the
following commands:

```
git clone git@github.com:AngularBootCamp/content-projection.git
